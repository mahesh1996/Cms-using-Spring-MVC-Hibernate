	    ...
	    <div class="container">
	    	...
	    	<div class="row">
	    		<div class="col-xs-12 text-center">
	    			<a href='<spring:url value="/post/add"></spring:url>'  class="btn btn-primary">Add <span class="glyphicon glyphicon-plus"></span></a>
	    		</div>
	    	</div>
	    	<div class="row">
	    		<table class="table table-striped table-hover ">
					  <thead>
					    <tr>
					      <th>#</th>
					      <th>Post</th>
					      <th>Edit <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></th>
					      <th>Delete <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></th>
					      <th>See Comments <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></th>
					    </tr>
					  </thead>
					  <tbody>
					  	<c:forEach items="${posts}" var="post" varStatus="loop">
						    <tr>
						      ...
						      <td>
							      <form action='<spring:url value="/post/edit"></spring:url>' method="get">
								      <input type="hidden" name="postId" value="${ post.id }">
								      <input type="submit" class="btn btn-warning" value="Edit">
							      </form>
						      </td>
						      <td>
							      <form action='<spring:url value="/post/delete"></spring:url>' method="post">
								      <input type="hidden" name="postId" value="${ post.id }">
								      <input type="submit" class="btn btn-danger" value="Delete">
							      </form>
						      </td>
						      <td>
							      <form action='<spring:url value="/post/comments"></spring:url>' method="get">
								      <input type="hidden" name="postId" value="${ post.id }">
								      <input type="submit" class="btn btn-primary" value="See Comments">
							      </form>
						      </td>
						    </tr>	  		
					  	</c:forEach>

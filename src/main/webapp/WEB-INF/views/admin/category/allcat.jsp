	    ...
	    <div class="container">
	    	...
	    	<div class="row">
	    		<div class="col-xs-12 text-center">
	    			<form class="form-horizontal" action='<spring:url value="/category/add"></spring:url>' method="post">
	    				<div class="form-group">
					      <label for="inputEmail" class="col-lg-2 control-label">Category Name</label>
					      <div class="col-lg-10">
					        <input class="form-control" id="inputEmail" placeholder="Category" type="text" name="category" required />
					      </div>
					    </div>
					  ...
					  <tbody>
					  	<c:forEach items="${categories}" var="cat" varStatus="loop">
						    <tr>
						      ...
						      <td><c:out value="${cat.text}" /></td>
						      <td>
							      <form action='<spring:url value="/category/delete"></spring:url>' method="post">
